...
<p align="center">
  ...
  <a href="#documentation">27 ADRs</a>
</p>
...
entry, by product and by customer · **credit notes** that put returned goods back into the lot they left from · **supplier returns** that send the freight nobody refunds to an expense · **documents** — the invoice, customs declaration and bill of lading attached to the entry they support · **bank reconciliation** — statements imported once, matched line by line, fees booked from the line · **Vietnam's statutory statements** — Mẫu B01/B02 for both Thông tư 200 and 133 · **Vietnamese e-invoices** — numbered without gaps, adjustment invoices for credit notes · **write-offs** with a reason · stock
...
- [ADR 24](docs/adr/0024-documents.md) — documents are kept in the ledger, checked, and never deleted
- [ADR 25](docs/adr/0025-bank-reconciliation.md) — the bank's statement is kept beside the books and matched line by line
- [ADR 26](docs/adr/0026-statutory-statements.md) — Vietnam's statutory statements are forms, defined as data
- [ADR 27](docs/adr/0027-vietnam-e-invoices.md) — the ledger issues the Vietnamese e-invoice document; a provider signs it
