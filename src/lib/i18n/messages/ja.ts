...
export const ja: Messages = {
  ...
  einvoice: {
    title: '電子インボイス',
    description: 'ベトナムの法定インボイス。記号ごとに連番で、売手と買手を税コードで記載します。',
    companyTitle: 'インボイスに載せる自社情報',
    companyHint: '税務署への登録どおりに入力します。記号は今年登録したもの（例：C26TAA）です。',
    legalName: '登録名称',
    taxId: '税コード（MST）',
    address: '登録住所',
    series: 'インボイス記号',
    ...
    cardTitle: '電子インボイス',
    cardHint:
      'この売上の法定インボイスです。電子インボイス事業者がこのファイルに署名し、税務署へ送信します。',
    needsCompany: '先に自社の登録情報を入力してください。',
    companyLink: '電子インボイスの設定',
    buyerName: '買手の登録名称',
    buyerTaxId: '買手の税コード',
    buyerTaxIdHint: '個人消費者の場合は空欄。',
    buyerAddress: '買手の住所',
    issue: '電子インボイスを発行',
    issued: (number) => `No. ${number} を発行しました。`,
    issueAdjustment: (reference) => `${reference} の修正インボイスを発行`,
    providerNote:
      '未署名です。XML を事業者（MISA・Viettel・VNPT・BKAV など）にアップロードして署名し、税務署のコードを取得してください。',
    checkForm: '内容を確認してもう一度お試しください。',
  },
  statutory: {
    title: '法定財務諸表',
    description: '通達が定める様式の貸借対照表と損益計算書です（ベトナム）。',
    balanceSheet: '貸借対照表',
    incomeStatement: '損益計算書',
    asOf: '基準日',
    from: '開始日',
    ...
    thisPeriod: '当期',
    lastYear: '前年同期',
    unplacedTitle: '様式に載っていない勘定',
    unplacedHint:
      '残高がありますが、どの項目にも該当しないコードの勘定です。勘定科目表のコードを付けないと、上の合計に含まれません。',
    unbalanced: '二つの合計が一致しません。原因は下に挙げた勘定です。',
    review: '帳簿から通達の様式で作成したものです。署名・提出の前に確認してください。',
    download: 'CSV をダウンロード',
    notAvailable: '法定財務諸表は、ベトナムの Thông tư 200 または 133 に従う帳簿で作成できます。',
    amountsIn: (currency) => `単位：${currency}`,
  },
  bank: {
    title: '銀行',
    description: '銀行明細と帳簿を一行ずつ照合します。',
    accountsCaption: '銀行明細のある口座',
    account: '口座',
    inBooks: '帳簿残高',
    perBank: '銀行残高',
    lines: '明細行',
    ...
    reconcile: '照合する',
    others: '別の口座で始める',
    noStatements: 'まだ明細を取り込んでいません',
    noStatementsBody: '下の口座を選び、銀行が出力した CSV を取り込んでください。',
    othersHint: '明細の口座を選んでください：預金口座、カード、借入金など。',
    noAccounts: '銀行口座がまだありません',
    noAccountsBody: '勘定科目に銀行用の資産勘定を作成し、ここで明細を取り込んでください。',
    back: 'すべての銀行口座',
    reconcileHint: '帳簿と銀行明細を並べて確認します。',
    asOf: (date) => `${date} 時点`,
    noStatementBalance: '明細に残高の列がありません',
    notInBooks: '未記帳',
    linesCount: (count) => `${count} 行`,
    reconciled: '一致',
    difference: '差額',
    importTitle: '明細を取り込む',
    importHint:
      'インターネットバンキングから CSV を出力し、ここで選んでください。取り込み済みの行は飛ばすので、期間が重なっても問題ありません。',
    file: '明細ファイル',
    importButton: '取り込む',
    imported: (added, skipped) =>
      skipped > 0
        ? `${added} 行を追加しました（${skipped} 行は取り込み済み）。`
        : `${added} 行を追加しました。`,
    chooseFile: '銀行が出力した CSV ファイルを選んでください。',
    toMatchTitle: '照合待ち',
    toMatchHint:
      '明細にあって帳簿にまだない行です。対応する仕訳と照合するか、帳簿にない場合（手数料・利息・記帳漏れの振込など）はここから記帳してください。',
    nothingToMatch: '明細の行はすべて帳簿にあります。',
    date: '日付',
    details: '内容',
    amount: '金額',
    action: '対応する取引',
    ...
    matched: '照合しました。',
    booked: '記帳して照合しました。',
    matchedCount: (count) => `${count} 行を照合しました。`,
    booksOnlyTitle: '帳簿にあって明細にないもの',
    booksOnlyHint:
      '多くは未決済の小切手や処理中の振込です。数週間以上前のものは確認をおすすめします。',
    nothingBooksOnly: '待ちはありません。',
    matchedTitle: '照合済み',
    entry: '仕訳',
    undo: '取り消す',
    undone: '照合を取り消しました。',
  ...
  documents: {
    title: '証憑',
    hint: '取引の根拠となる書類：仕入先の請求書、輸入申告書、船荷証券など。PDF・画像・XML 電子インボイス、4 MB まで。',
    none: '添付はまだありません。',
    file: 'ファイル',
    kind: '種類',
    kindInvoice: '請求書',
    kindReceipt: '領収書',
    kindCustomsDeclaration: '輸入申告書',
    kindBillOfLading: '船荷証券',
    kindDeliveryNote: '納品書',
    kindContract: '契約書',
    kindOther: 'その他',
    note: 'メモ（任意）',
    attach: '添付',
    remove: '外す',
    download: 'ダウンロード',
    attached: (name) => `${name} を添付しました。`,
    removed: '外しました。ファイル自体は記録として残ります。',
    chooseFile: '添付するファイルを選んでください。',
  },
  creditNotes: {
    title: '返品・値引',
