...
const STATUS_BY_CODE: Record<LedgerError['code'], number> = {
  ...
  credit_note_reference_taken: 409,
  credit_note_not_found: 404,
  credit_note_has_no_lines: 422,
  credit_line_not_on_sale: 422,
  credit_line_repeated: 422,
  credit_exceeds_sale: 409,
  credit_before_sale: 422,
  supplier_return_reference_taken: 409,
  supplier_return_not_found: 404,
  supplier_refund_exceeds_lot: 409,
  supplier_return_before_receipt: 422,
  supplier_return_tax_needs_local_currency: 422,
  supplier_account_required: 422,
  supplier_return_exceeds_lot: 409,
  document_not_found: 404,
  document_link_not_found: 404,
  document_empty: 422,
  document_too_large: 413,
  document_type_not_allowed: 415,
  bank_account_not_reconcilable: 422,
  bank_line_not_found: 404,
  bank_statement_unreadable: 422,
  bank_statement_has_problems: 422,
  bank_line_already_matched: 409,
  bank_posting_already_matched: 409,
  bank_line_not_matched: 409,
  bank_match_amount_mismatch: 422,
  bank_posting_not_on_account: 422,
  einvoice_seller_incomplete: 422,
  einvoice_series_year: 422,
  einvoice_already_issued: 409,
  einvoice_original_missing: 409,
