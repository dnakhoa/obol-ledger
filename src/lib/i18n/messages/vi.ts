...
export const vi: Messages = {
  ...
  einvoice: {
    ...
    description:
      'Hóa đơn hợp pháp tại Việt Nam: đánh số theo ký hiệu, ghi rõ mã số thuế người bán và người mua.',
    companyTitle: 'Thông tin công ty trên hóa đơn',
    companyHint:
      'Theo đăng ký với cơ quan thuế. Ký hiệu là ký hiệu đã đăng ký cho năm nay, ví dụ C26TAA.',
    legalName: 'Tên đăng ký',
    taxId: 'Mã số thuế',
    address: 'Địa chỉ đăng ký',
    series: 'Ký hiệu hóa đơn',
    save: 'Lưu',
    saved: 'Đã lưu.',
    issuedTitle: 'Đã lập',
    none: 'Chưa lập hóa đơn điện tử nào.',
    number: 'Số',
    date: 'Ngày',
    kind: 'Loại',
    original: 'Hóa đơn',
    ...
    total: 'Tổng cộng',
    download: 'XML',
    cardTitle: 'Hóa đơn điện tử',
    cardHint:
      'Hóa đơn hợp pháp cho lần bán này. Nhà cung cấp hóa đơn điện tử ký số và gửi cơ quan thuế từ tệp này.',
    needsCompany: 'Hãy nhập thông tin đăng ký của công ty trước.',
    companyLink: 'Cài đặt hóa đơn điện tử',
    buyerName: 'Tên người mua',
    buyerTaxId: 'Mã số thuế người mua',
    buyerTaxIdHint: 'Để trống nếu là người tiêu dùng.',
    buyerAddress: 'Địa chỉ người mua',
    issue: 'Lập hóa đơn điện tử',
    issued: (number) => `Đã lập hóa đơn số ${number}.`,
    issueAdjustment: (reference) => `Lập hóa đơn điều chỉnh cho ${reference}`,
    providerNote:
      'Chưa ký số. Hãy tải tệp XML lên nhà cung cấp — MISA, Viettel, VNPT, BKAV hoặc khác — để ký và lấy mã của cơ quan thuế.',
    checkForm: 'Hãy kiểm tra thông tin rồi thử lại.',
  },
  statutory: {
    title: 'Báo cáo tài chính',
    description: 'Bảng cân đối kế toán và báo cáo kết quả kinh doanh theo mẫu của thông tư.',
    balanceSheet: 'Bảng cân đối kế toán',
    ...
    item: 'Chỉ tiêu',
    code: 'Mã số',
    endOfPeriod: 'Số cuối kỳ',
    startOfYear: 'Số đầu năm',
    thisPeriod: 'Kỳ này',
    lastYear: 'Cùng kỳ năm trước',
    unplacedTitle: 'Tài khoản chưa vào mẫu biểu',
    unplacedHint:
      'Các tài khoản này có số dư nhưng mã tài khoản không thuộc chỉ tiêu nào. Hãy gán mã theo hệ thống tài khoản, nếu không số tổng ở trên sẽ thiếu chúng.',
    unbalanced: 'Hai số tổng không khớp. Lý do là các tài khoản liệt kê bên dưới.',
    review: 'Lập từ sổ sách theo mẫu của thông tư. Hãy rà soát trước khi ký và nộp.',
    download: 'Tải CSV',
    notAvailable:
      'Báo cáo tài chính theo mẫu được lập cho sổ sách theo Thông tư 200 hoặc Thông tư 133.',
    amountsIn: (currency) => `Đơn vị tính: ${currency}.`,
  },
  bank: {
    title: 'Ngân hàng',
    description: 'Đối chiếu sao kê ngân hàng với sổ sách, từng dòng một.',
    accountsCaption: 'Tài khoản có sao kê ngân hàng',
    account: 'Tài khoản',
    inBooks: 'Theo sổ sách',
    perBank: 'Theo ngân hàng',
    lines: 'Dòng sao kê',
    toMatch: 'Chưa đối chiếu',
    latestLine: 'Dòng gần nhất',
    reconcile: 'Đối chiếu',
    others: 'Bắt đầu với tài khoản khác',
    noStatements: 'Chưa nhập sao kê nào',
    noStatementsBody: 'Chọn tài khoản bên dưới, rồi nhập tệp CSV ngân hàng xuất ra.',
    othersHint: 'Chọn tài khoản của sao kê: tài khoản ngân hàng, thẻ hoặc khoản vay.',
    noAccounts: 'Chưa có tài khoản ngân hàng',
    noAccountsBody:
      'Hãy mở một tài khoản tài sản cho ngân hàng trong hệ thống tài khoản, rồi nhập sao kê tại đây.',
    back: 'Tất cả tài khoản ngân hàng',
    reconcileHint: 'Sổ sách đặt cạnh sao kê của ngân hàng.',
    asOf: (date) => `ngày ${date}`,
    noStatementBalance: 'Sao kê không có cột số dư',
    notInBooks: 'Chưa có trong sổ',
    linesCount: (count) => `${count} dòng`,
    reconciled: 'Đã khớp',
    difference: 'Chênh lệch',
    importTitle: 'Nhập sao kê',
    importHint:
      'Xuất tệp CSV từ ngân hàng điện tử rồi chọn tại đây. Dòng đã nhập sẽ được bỏ qua, nên các kỳ trùng nhau không sao.',
    file: 'Tệp sao kê',
    importButton: 'Nhập',
    imported: (added, skipped) =>
      skipped > 0
        ? `Đã thêm ${added} dòng; ${skipped} dòng đã có từ trước.`
        : `Đã thêm ${added} dòng.`,
    chooseFile: 'Hãy chọn tệp CSV ngân hàng đã xuất.',
    toMatchTitle: 'Cần đối chiếu',
    toMatchHint:
      'Có trên sao kê nhưng chưa có trong sổ. Đối chiếu từng dòng với bút toán tương ứng, hoặc ghi sổ nếu chưa có — phí ngân hàng, lãi, khoản chuyển chưa ai nhập.',
    nothingToMatch: 'Mọi dòng trên sao kê đều đã có trong sổ.',
    date: 'Ngày',
    details: 'Nội dung',
    amount: 'Số tiền',
    action: 'Là khoản nào',
    looksLike: 'Có vẻ là',
    match: 'Đối chiếu',
    matchAll: (count) => `Đối chiếu ${count} dòng được gợi ý`,
    chooseEntry: 'Chọn bút toán',
    bookTo: 'Ghi vào',
    book: 'Ghi sổ',
    chooseAccount: 'Chọn tài khoản',
    matched: 'Đã đối chiếu.',
    booked: 'Đã ghi sổ và đối chiếu.',
    matchedCount: (count) => `Đã đối chiếu ${count} dòng.`,
    booksOnlyTitle: 'Có trong sổ, chưa có trên sao kê',
    booksOnlyHint:
      'Thường là séc chưa lĩnh và khoản chuyển đang xử lý. Khoản nào quá vài tuần nên được kiểm tra.',
    nothingBooksOnly: 'Không có khoản nào đang chờ.',
    matchedTitle: 'Đã đối chiếu',
    entry: 'Bút toán',
    undo: 'Hủy',
    undone: 'Đã hủy đối chiếu.',
  },
  documents: {
    title: 'Chứng từ',
    hint: 'Chứng từ gốc: hóa đơn nhà cung cấp, tờ khai hải quan, vận đơn. Tệp PDF, ảnh hoặc hóa đơn điện tử XML, tối đa 4 MB.',
    none: 'Chưa có chứng từ nào.',
    file: 'Tệp',
    kind: 'Loại chứng từ',
    kindInvoice: 'Hóa đơn',
    kindReceipt: 'Phiếu thu / biên lai',
    kindCustomsDeclaration: 'Tờ khai hải quan',
    kindBillOfLading: 'Vận đơn',
    kindDeliveryNote: 'Phiếu giao hàng',
    kindContract: 'Hợp đồng',
    kindOther: 'Khác',
    note: 'Ghi chú (không bắt buộc)',
    attach: 'Đính kèm',
    remove: 'Gỡ',
    download: 'Tải về',
    attached: (name) => `Đã đính kèm ${name}.`,
    removed: 'Đã gỡ. Tệp gốc vẫn được lưu.',
    chooseFile: 'Hãy chọn tệp cần đính kèm.',
  },
  creditNotes: {
