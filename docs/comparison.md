...
| **Importing invoices from a spreadsheet**            | The costing engine exists; getting a decade of purchase history into it still means typing. A CSV import that opens lots from a supplier ledger is the next piece                                                      |
