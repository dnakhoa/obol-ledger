...
| **Customer returns and credit notes**                | A sale is append-only and cannot be reversed from the journal; a return should reopen stock at the cost it left at and credit the receivable, as its own record                                                                                                       |
